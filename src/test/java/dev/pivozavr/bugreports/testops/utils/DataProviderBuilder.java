package dev.pivozavr.bugreports.testops.utils;
...
/**
 * Класс-обертка, упрощающий заполнение dataProvider'а данными
 * dataProvider позволяет прогнать один и тот-же тест с разными параметрами
 */
